...
$string['pluginname'] = 'Mouse Tracking';
$string['mcmmmsk'] = 'Mouse Tracking';
$string['mcmmmsk:addinstance'] = 'Add a new Mouse Tracking block';
$string['mcmmmsk:myaddinstance'] = 'Add a new Mouse Tracking block to the My Moodle page';
...
$string['default'] = 'Default Logging';
$string['defaultdesc'] = 'The default way which is recommended to be checked.';
$string['pagetracking'] = 'Pagetracking';
$string['pagetrackingdesc'] = 'Unlike default, summarize whole logging of a single page by removing x and y locations, minimal information but also minimal data rate.';
$string['roitracking'] = 'Roitracking (still in test phase)';
$string['roitrackingdesc'] = 'Unlike default, summarize areas of a page instead of each x and y locations, in other words region of interest, scaling the resolution.';
...
$string['page_debug_amount'] = 'Debug Pagetracking Amount';
$string['page_debug_amountdesc'] = 'Log pagetracking activities on console.';
$string['roi_debug_amount'] = 'Debug Roitracking Amount';
$string['roi_debug_amountdesc'] = 'Log roitracking activities on console.';
...
$string['savedatabasedefaulteach_checkbox'] = 'Default Data to Database on Fly';
$string['savedatabasedefaulteach_checkboxdesc'] = 'Automatically save default logs to database.';
$string['pagedatabasedefaulteach_checkbox'] = 'Page Data to Database on Fly';
$string['pagedatabasedefaulteach_checkboxdesc'] = 'Automatically save page logs to database.';
$string['roidatabasedefaulteach_checkbox'] = 'Roi Data to Database on Fly';
$string['roidatabasedefaulteach_checkboxdesc'] = 'Automatically save roi logs to database.';
