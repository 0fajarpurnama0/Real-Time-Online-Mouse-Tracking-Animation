...
function xmldb_theme_mcmmmskclean_upgrade($oldversion) {
    global $CFG, $DB;
...
// Insert PHP code from XMLDB Editor here
    if ($oldversion < 2019061100) {
        ...
        // Define table theme_mcmmmskclean to be created.
        $table = new xmldb_table('theme_mcmmmskclean');

        // Adding fields to table theme_mcmmmskclean.
        ...
        // Adding keys to table theme_mcmmmskclean.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Conditionally launch create table for theme_mcmmmskclean.
        //if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        //}

        // Mcmmmskaclean savepoint reached.
        upgrade_plugin_savepoint(true, 2019061100, 'theme', 'mcmmmskclean');
    }
