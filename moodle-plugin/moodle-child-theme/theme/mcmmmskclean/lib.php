 ...
 */
function theme_mcmmmskclean_process_css($css, $theme) {
    global $OUTPUT;

    // Set the background image for the logo.
    $logo = $OUTPUT->get_logo_url(null, 75);
    $css = theme_mcmmmskclean_set_logo($css, $logo);
    ...
    $css = theme_mcmmmskclean_set_customcss($css, $customcss);
 ...
 */
function theme_mcmmmskclean_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_mcmmmskclean_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM and ($filearea === 'logo' || $filearea === 'smalllogo')) {
        $theme = theme_config::load('mcmmmskclean');
 ...
 */
function theme_mcmmmskclean_set_customcss($css, $customcss) {
 ...
 *
 * Do not add mcmmmskClean specific logic in here, child themes should be able to
 ...
 */
function theme_mcmmmskclean_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
...
/**
 * All theme functions should start with theme_mcmmmskclean_
 * @deprecated since 2.5.1
 */
function mcmmmskclean_process_css() {
 ...
 * @deprecated since 2.5.1
 */
function mcmmmskclean_set_logo() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}
 ...
 * @deprecated since 2.5.1
 */
function mcmmmskclean_set_customcss() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}
