...
$(document).ready(function(){
    ...
    function transparency_control(){
      $("body *").css("opacity", result.transparency_control/100).hover(function() {
        $(this).fadeTo( "fast", 1 );
      }, function() {
        $(this).fadeTo( "fast", result.transparency_control/100);
      });
    }
    transparency_control();
	...
	if(parseInt($(this).css('font-size')) <= result.fontsize_magnifier){
        	$(this).css('font-size', result.fontsize_magnifier+'px');
	}
      }, function() {
        $(this).css('font-size', '');
      });
    ...
    function background_color(){
      if (result.background_color_checkbox) {
        $("*").hover(function() {
          ...
          $(this).css('background-color', result.background_color);
        }, function() {
...
$(window).ready(function(){
    ...
    if (result.bubble_view_imitation_checkbox) {
      ...
      $(document).ready(function(){bubbleview();})
