...
$(document).ready(function(){
    ...
    function saveChanges() {
		...
		if($('#restricted-focus-viewer-imitation-checkbox').prop( "checked" )){
			therestricted_focus_viewer_imitation_checkbox = true;
		} else {
			therestricted_focus_viewer_imitation_checkbox = false;
		}
		...
		if($('#bubble-view-imitation-checkbox').prop( "checked" )){
			thebubble_view_imitation_checkbox = true;
		} else {
			thebubble_view_imitation_checkbox = false;
		}
		...
		if($('#finger-tracing-learning-system-imitation-checkbox').prop( "checked" )){
			thefinger_tracing_learning_system_imitation_checkbox = true;
		} else {
			thefinger_tracing_learning_system_imitation_checkbox = false;
		}
		...
		if($('#background-color-checkbox').prop( "checked" )){
			thebackground_color_checkbox = true;
		} else {
			thebackground_color_checkbox = false;
		}
		...
		if($('#color-checkbox').prop( "checked" )){
			thecolor_checkbox = true;
		} else {
			thecolor_checkbox = false;
		}
		var color_checkbox;
		...
		*/
		...
		function loadChanges(){
			...
			if(result.restricted_focus_viewer_imitation_checkbox){
			...
			if(result.bubble_view_imitation_checkbox){
			...
			if(result.finger_tracing_learning_system_imitation_checkbox){
