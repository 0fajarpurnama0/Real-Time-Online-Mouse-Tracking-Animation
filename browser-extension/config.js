...
$(document).ready(function() {
	...
	$('body').append(' <div id="dialog" title="Configuration"> <p>Hello, please support us in our user interraction project by allowing us to record your interractions:</p> </div> <br />');
	...
	<li><input type="checkbox" id="ipaddress-checkbox" checked="checked"> IP Address </li> 
